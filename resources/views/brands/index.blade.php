        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Kategori Brand Baru</h4>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">List Brand Lokal</h4>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form onsubmit="return confirm('Yakin Hapus Kategori ?')" action="{{ route('brand.destroy', $cat->id) }}" method="post">
                                                    <!-- KONVERSI DARI @ CSRF & @ METHOD AKAN DIJELASKAN DIBAWAH -->
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{ route('brand.edit', $cat->id) }}" class="btn btn-warning btn-sm">Edit</a>
