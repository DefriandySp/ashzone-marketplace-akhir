            ...
            <tr class="top">
                <td colspan="2">
                    <table>
                        <tr>
                            <td class="title">
                                <img src="https://cdn4.iconfinder.com/data/icons/e-commerce-and-shopping-3/500/shirt-star-512.png" width="150px">
                            </td>
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                {{ $order->city->name }} {{ $order->postal_code }}<br>
                                {{ $order->city->province->name }}
                            </td>
                            ...
                            <td>
                                ...
                                082385835280<br>
                                Jl. Sudirman<br>
                                Bukit Cangang Kayu Ramang, Kecamatan Guguk Panjang<br>
                                Kota Bukittinggi
                            </td>
                        </tr>
                    </table>
