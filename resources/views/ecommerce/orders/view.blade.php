...
@section('title')
    <title>Order {{ $order->invoice }} - AshZone</title>
@endsection
								...
								<div class="card-body">
									<table>
                                        ...
                                        <tr>
                                            <td>Alamat</td>
                                            <td>:</td>
                                            <th>{{ $order->customer_address }}, {{ $order->city->name }}, {{ $order->city->province->name }}</th>
                                        </tr>
                                    </table>
								</div>
							</div>
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3" class="text-center"><b>Rp. {{ number_format($order->subtotal) }}</b></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center">Kurir <b>{{ $order->shipping }}</b></td>
                                                    <td colspan="3" class="text-center"><b>Rp. {{ number_format($order->cost) }}</b></td>
                                                </tr>
                                                <tr>
