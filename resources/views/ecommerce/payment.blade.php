...
@section('title')
<title>Konfirmasi Pembayaran - AshZone</title>
@endsection
                                ...
                                <form action="{{ route('customer.savePayment') }}" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="transfer_to" class="form-control" required>
                                            ...
                                            <option value="BCA - 1234567">BCA: 1234567 a.n AshZone</option>
                                            <option value="Mandiri - 2345678">Mandiri: 2345678 a.n AshZone</option>
                                            <option value="BRI - 9876543">BRI: 9876543 a.n AshZone</option>
                                            <option value="BNI - 6789456">BNI: 6789456 a.n AshZone</option>
                                        </select>
                                        <p class="text-danger">{{ $errors->first('transfer_to') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Jumlah Transfer</label>
                                        <input type="amount" name="amount" class="form-control" value="Rp. {{ number_format($order->total) }}" required readonly>
                                        <!-- @if (auth()->guard('customer')->check())
                                        value="{{ number_format($order->total) }}" required
